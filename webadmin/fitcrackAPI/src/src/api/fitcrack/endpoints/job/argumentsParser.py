...
jobList_parser.add_argument('attack_mode', type=str, required=False, help='filtrovanie podľa typu útoku')
jobList_parser.add_argument('order_by', type=str, required=False, help='zoradenie výsledkov',
...
addJob_model = api.schema_model('addJob', {
    ...
    'properties': {
        ...
        'time_start': {
            "format": "date-time",
            "type": "string",
            "description": "Kedy sa ma job zacat crackovat."
        },
        'time_end': {
            "format": "date-time",
            "type": "string",
            "description": "Kedy ma fitcrack prestat crackovat job."
        },
        'attack_settings': {
            'type': 'object',
