...
CREATE TABLE IF NOT EXISTS `fc_job` (
  ...
  `case_permute` tinyint(1) unsigned DEFAULT NULL,
  `check_duplicates` tinyint(1) unsigned DEFAULT NULL,
  `min_password_len` int(10) unsigned NOT NULL DEFAULT '1',
  `max_password_len` int(10) unsigned NOT NULL DEFAULT '16',
  `min_elem_in_chain` int(10) unsigned NOT NULL DEFAULT '1',
  `max_elem_in_chain` int(10) unsigned NOT NULL DEFAULT '16',
