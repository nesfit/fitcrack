...
::google::protobuf::internal::DescriptorTable descriptor_table_protocol_2eproto = {
  ...
  "protocol.proto", &assign_descriptors_table_protocol_2eproto, 1172,
};
...
Grammar::Grammar(const Grammar& from)
  ...
  rulename_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.rulename().size() > 0) {
    rulename_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.rulename_);
  }
...
void Grammar::SharedDtor() {
  rulename_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:proto.Grammar)
  ...
  sections_.Clear();
  mapping_.Clear();
  rulename_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  _internal_metadata_.Clear();
}
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("proto.Grammar.ruleName");
        object = msg->mutable_rulename();
        if (size > end - ptr + ::google::protobuf::internal::ParseContext::kSlopBytes) {
          parser_till_end = ::google::protobuf::internal::GreedyStringParserUTF8;
          goto string_till_end;
        }
...
void Grammar::InternalSwap(Grammar* other) {
  ...
  rulename_.Swap(&other->rulename_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
}
